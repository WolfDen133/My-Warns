...
class Main extends PluginBase implements Listener {
    ...
    private function registerCommands () : void
    {
        ...
        $cmap->register("MyWarns", new WarnCommand($this));
        $cmap->register("MyWarns", new MyWarnsCommand($this));
        $cmap->register("MyWarns", new RemoveWarnCommand($this));
        $cmap->register("MyWarns", new SeeWarnsCommand($this));
        $cmap->register("MyWarns", new PlayersCommand($this));
    }
